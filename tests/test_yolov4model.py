...
from sahi.utils.yolov4 import (
    Yolov4TestConstants,
    download_yolov4_model,
)


class TestYolov4DetectionModel(unittest.TestCase):
    def test_load_model(self):
        from sahi.model import Yolov4DetectionModel

        download_yolov4_model()

        yolov4_detection_model = Yolov4DetectionModel(
            model_path=Yolov4TestConstants.YOLOV4_MODEL_PATH,
            config_path=Yolov4TestConstants.YOLOV4_CONFIG_PATH,
            names_path=Yolov4TestConstants.YOLOV4_NAMES_PATH,
        ...
        self.assertNotEqual(yolov4_detection_model.model, None)
    ...
    def test_perform_inference(self):
        ...
        yolov4_detection_model = Yolov4DetectionModel(
            ...
            config_path=Yolov4TestConstants.YOLOV4_CONFIG_PATH,
            names_path=Yolov4TestConstants.YOLOV4_NAMES_PATH,
            prediction_score_threshold=0.1,
            device=None,
            category_remapping=None,
            load_at_init=True,
        )
        ...
        # perform inference
        yolov4_detection_model.perform_inference(image)
        original_predictions = yolov4_detection_model.original_predictions
